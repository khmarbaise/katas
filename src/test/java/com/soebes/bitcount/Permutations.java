...
/**
 * Klassen, um die Permutationen einer Liste zu erstellen.
 *
 * Verwendung liste der Import Dateien. Somit können alle möglichen Kombinationen erstellt werden und getestet werden.
 *
