...
class BitCountingByteTest {
  ...
  void firstTest() {
    ...
    System.out.println("value:" + Integer.toHexString(Byte.toUnsignedInt(value)) + " " + Integer.toBinaryString(Byte.toUnsignedInt(value)) + " Byte:" + Byte
      .toUnsignedInt(value));
  ...
  class ShiftTest {
    ...
    void name() {
        ...
        System.out.printf("%32s%n",Integer.toBinaryString(c >>= 1));
        System.out.printf("%32s%n", Integer.toBinaryString(c <<= 1));
        System.out.printf("%32s%n",Integer.toBinaryString(c >>>= 1));
